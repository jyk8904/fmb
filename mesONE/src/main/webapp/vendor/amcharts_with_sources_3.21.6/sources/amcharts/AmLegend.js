                ...
                for (i = 0; i < valueLabels.length; i++) {
                    ...
                    if (!data) {
                        ...
                        if (dataItem.type !== undefined) {
                            ...
                            if (dataItem.legendPeriodValueTextR) {
                                periodValueText = dataItem.legendPeriodValueTextR;
                            }                            
                            ...
                            if (currentDataItem) {
                                ...
                                if (dataItem.legendValueTextR) {
                                    formattedText = dataItem.legendValueTextR;
                                }                                 
                        ...
                        if(!dataItem.pattern){
                            ...
                            if (_this.useMarkerColorForLabels) {
                                ...
                                if (legendLabel) {
                                    if(dataItem.hidden){
                                        legendLabel.setAttr("fill", _this.markerDisabledColor);
                                    }
                                    else{
