(function() {
    ...
    AmCharts.AxisBase = AmCharts.Class({
        construct: function(theme) {
            var _this = this;
            _this.createEvents("clickItem", "rollOverItem", "rollOutItem", "rollOverGuide", "rollOutGuide", "clickGuide");
            _this.dx = 0;
            _this.dy = 0;
            _this.x = 0;
            _this.y = 0;
        ...
        handleGuideClick: function(guide) {
            var _this = this;
            this.chart.hideBalloon();
            var event = {
                type: "clickGuide",
