                    ...
                    if (segments) {
                        for (var s = 0; s < segments.length; s++) {
                            ...
                            if (parseDates) {
                                ...
                                if (chartStartDate) {
                                    if (!isNaN(start)) {
                                        startDate = AmCharts.changeDate(AmCharts.newDate(chartStartDate,"fff"), period, start * periodCount, true, true);
                                    }
                                    if (!isNaN(end)) {
                                        endDate = AmCharts.changeDate(AmCharts.newDate(chartStartDate, "fff"), period, end * periodCount, true, true);
                                    }
                                }
