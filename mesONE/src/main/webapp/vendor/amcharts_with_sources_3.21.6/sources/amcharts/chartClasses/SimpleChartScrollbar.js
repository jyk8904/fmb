(function() {
    ...
    AmCharts.SimpleChartScrollbar = AmCharts.Class({
        ...
        handleDragStart: function() {
            ...
            if (_this.enabled) {
                ...
                if (AmCharts.isModern) {
                    _this.dragger.node.style.cssText = _this.dragCursorDown;
                }
                _this.dragging = true;
                var bbox = _this.getDBox();
                if (_this.rotate) {
        ...
        handleDragStop: function() {
            ...
            if (AmCharts.isModern) {
                _this.dragger.node.style.cssText = _this.dragCursorHover;
            }
            _this.update();
        ...
        updateGripCursor: function(down) {
            ...
            if (AmCharts.isModern) {
                ...
                if (resizeCursor) {
                    if (_this.iconRight) {
                        _this.iconRight.node.style.cssText = resizeCursor;
                    }
                    if (_this.iconLeft) {
                        _this.iconLeft.node.style.cssText = resizeCursor;
                    }
                }
            }
        },
