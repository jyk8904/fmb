    ...
    AmCharts.AmChart = AmCharts.Class({
            ...
            if (AmCharts.ifArray(titles)) {
                ...
                for (i = 0; i < titles.length; i++) {
                    ...
                    if (title.enabled !== false) {
                        ...
                        var dw = 35;
                        var titleLabel = AmCharts.wrappedText(_this.container, title.text, color, _this.fontFamily, size, "middle", bold, _this.realWidth - dw - _this.marginRight - marginLeft);
        ...
        afterWrite: function(divId) {
            ...
            if (div) {
                ...
                if (_this.mouseWheelScrollEnabled || _this.mouseWheelZoomEnabled) {
                    AmCharts.addWheelListeners();
                }
