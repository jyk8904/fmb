            ...
            if (xx.length > 1) {
                ...
                if (fillAlphas > 0) {
                    ...
                    if (negativeFillColors || negativeLineColor !== undefined) {
                        ...
                        var negativeFill = new AmCharts.Bezier(container, xxx, yyy, NaN, 0, 0, negativeFillColors, negativeFillAlphas, dashLength, endStr, gradientRotation);
                ...
                if (balloon) {
                    if (balloon.enabled && _this.showBalloon && !_this.hidden) {
                        ...
                        if (text && text !== "") {
                            ...
                            if (!follow) {
                                if (chart.type != "radar") {
                                    if (bx < dx - 0.5 || bx > width + dx || by < dy - 0.5 || by > height + dy) {
