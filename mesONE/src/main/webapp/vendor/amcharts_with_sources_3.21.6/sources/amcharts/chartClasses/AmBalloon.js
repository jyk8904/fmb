        ...
        draw: function() {
            ...
            if (!isNaN(ptx)) {
                ...
                if (_this.show) {
                    ...
                    var innerStyle = textInnerDiv.style;
                    
                    if (!isNaN(minWidth)) {
                        innerStyle.minWidth = (minWidth - horizontalPadding * 2) + "px";
                    }
                    
                    innerStyle.textAlign = _this.textAlign;
                    innerStyle.maxWidth = _this.maxWidth + "px";
                    innerStyle.fontSize = textSize + "px";
                    innerStyle.color = _this.color;
                    innerStyle.fontFamily = fontFamily;
                    textInnerDiv.innerHTML = _this.text;
