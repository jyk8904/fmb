...
angular.module('app').controller('FmbTotalCtrl',['CmmAjaxService','CmmWorkerSrvc','$http','$scope','$window','$q','$timeout','$mdSidenav','$interval','$location',	'$rootScope',									
	 ...
	 *-----------------------------------------*/
		...
		function getPlanProgress() {
			// 계획진도율 가져오기
			var planProgressPromise = CmmAjaxService.select("bas/selectPlanProgress.do");
		...
		function getDefectInfo() {
			// 계획진도율 가져오기
			var getDefectChart = CmmAjaxService.select("bas/selectFmbDefectChart.do");
			...
			var getDefectRank = CmmAjaxService.select("bas/selectFmbDefectRank.do");
			...
			var getDefectRate = CmmAjaxService.select("bas/selectFmbDefectRate.do");
		...
		function getGaugeRunRate() {
			// 라인가동현황게이지 가져오기
			var gaugeRunRatePromise = CmmAjaxService.select("bas/selectGaugeRunRate.do");
		...
		function getGaugeRunInfo() {	
			// 라인가동현황 그리드 가져오기
			var gaugeRunInfoPromise = CmmAjaxService.select("bas/selectGaugeRunInfo.do");
		...
		function getRankRunInfo() {
			//설비상태별 발생량 순위 가져오기
			var rankRunInfoPromise = CmmAjaxService.select("bas/selectRankRunInfo.do");
